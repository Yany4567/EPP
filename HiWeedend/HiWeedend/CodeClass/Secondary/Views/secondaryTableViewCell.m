...
- (void)addCells{
    ...
    //显示距离的lab
    self.distanceLab = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.poiLab.frame)+3, CGRectGetMinY(self.poiLab.frame), CGRectGetWidth(self.poiLab.frame)-30, CGRectGetHeight(self.poiLab.frame))];
    ...
    //类别
    self.categoryLab = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.distanceLab.frame)+3, CGRectGetMinY(self.distanceLab.frame), CGRectGetWidth(self.poiLab.frame)-10, CGRectGetHeight(self.distanceLab.frame))];
    ...
    //日期
    self.time_infoLab = [[UILabel alloc]initWithFrame:CGRectMake(7, CGRectGetMaxY(self.distanceLab.frame)+3, CGRectGetWidth(self.categoryLab.frame), CGRectGetHeight(self.distanceLab.frame)-5)];
